  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium '>
      ...
      <div className='flex items-center gap-6'>
        <button onClick={handleAdminRedirect} className='text-sm font-light text-gray-950 hover:text-gray-600 transition-colors'>ADMIN</button>
        <img onClick={() => {
          setShowSearch(true)
          navigate('/collection')
